    ...
    <div className="bg-white rounded-[14px] shadow-[0_2px_12px_rgba(26,34,54,0.07)] border border-[#e4e8f0] overflow-hidden">
      ...
      <div className="overflow-x-auto min-h-[200px]">
        {topCustomers?.length > 0 ? (
          <table className="w-full border-collapse">
            <thead>
              <tr>
                ...
                <th className="p-[9px_16px] text-[11px] font-semibold text-[#7a8aaa] text-center bg-[#f4f6fb] border-b border-[#e4e8f0] whitespace-nowrap">
                  লেনদেন
                </th>
            ...
            <tbody>
              {topCustomers.map((c) => (
                ...
                >
                  ...
                  <td className="p-[10px_16px] text-center text-[#7a8aaa] text-[12px]">
                    {c.txn} টি
                  </td>
          ...
          <div className="flex items-center justify-center h-[150px] text-[#7a8aaa] text-[13px]">
