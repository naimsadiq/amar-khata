    ...
    <div className="animate-in fade-in slide-in-from-right-2 duration-300">
      ...
      <div className="mx-4 mt-5 relative">
        ...
        <input
          ...
          className="w-full border border-gray-200 rounded-xl py-3 pl-10 pr-4 text-[14px] outline-none focus:border-[#10b981] focus:ring-1 focus:ring-[#10b981] transition-all"
        />
      </div>

      {/* Empty State */}
      <div className="flex flex-col items-center justify-center mt-16 text-center px-4">
        <p className="text-gray-400 text-[15px]">No suppliers found.</p>
        <p className="text-gray-400 text-[15px]">Please add some suppliers.</p>
      </div>
